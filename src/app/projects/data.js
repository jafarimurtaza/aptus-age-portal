export const projects = [
  {
    ...
    outcome:
      "The final result is a clear directory experience where users can explore organizations and access community information easily.",

    nextStep:
      "The next improvement is adding real NGO profiles, saved organizations, and a dashboard for organizations.",
...

  {
    ...
    nextStep:
      "The next improvement is connecting real task data and adding role-based team views.",
...

  {
    ...
    nextStep:
      "The next improvement is adding doctor room assignment and SMS notifications.",
