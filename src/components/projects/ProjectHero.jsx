        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          <div className="max-w-2xl">
            ...
            <h1 className=" mt-8 text-4xl font-extrabold leading-tight text-white sm:text-5xl lg:text-6xl">
              ...
              Projects Built by
              <br />
              <span className="text-[#D6A04A]">Afghan Geeks</span>
            </h1>
            ...
            <div className="mt-8">
              <Link
                href="/graduates"
                className=" inline-flex items-center rounded-xl bg-[#D6A04A] px-7 py-3.5 text-base font-semibold text-white transition duration-300 hover:bg-[#C98B2F] "
              >
                Meet Our Graduates
              </Link>
            </div>
