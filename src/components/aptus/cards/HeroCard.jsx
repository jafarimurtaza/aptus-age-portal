...
export default function HeroCard() {
  return (
    <motion.article
      ...
      className="relative min-h-31 overflow-hidden rounded-2xl bg-[linear-gradient(137deg,#176545_0%,#0F5239_58%,#0C4733_100%)] px-4 py-4 text-white shadow-[0_18px_34px_rgba(15,82,57,0.28)]"
    >
