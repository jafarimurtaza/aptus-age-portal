  ...
  return (
    <form className="flex items-center gap-4" onSubmit={handleSubmit}>
      <div className="flex h-15.5 min-w-0 flex-1 items-center rounded-full border border-[#E6ECE8] bg-white px-6 shadow-[inset_0_1px_0_rgba(255,255,255,0.9),0_8px_18px_rgba(31,50,44,0.055)] transition-colors duration-300 dark:border-white/10 dark:bg-[#17231E] dark:shadow-[inset_0_1px_0_rgba(255,255,255,0.04),0_10px_24px_rgba(0,0,0,0.18)]">
        ...
        <div className="ml-3 flex items-center gap-5 text-[#53636E] dark:text-[#AFC0B8]">
          <button
            type="button"
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.96 }}
        disabled={!canSend}
        className="flex h-13.5 w-13.5 shrink-0 items-center justify-center rounded-full bg-aptus-green text-white shadow-[0_12px_24px_rgba(57,184,112,0.28)] transition hover:bg-[#30AA66] disabled:cursor-not-allowed disabled:opacity-70"
      >
        <Send className="h-5 w-5 -translate-x-px translate-y-px fill-current" strokeWidth={2.1} />
      </motion.button>
    </form>
  );
}
