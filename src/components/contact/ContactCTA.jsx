  ...
  return (
    <section className="bg-base-100 py-20">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="relative overflow-hidden bg-primary px-6 py-14 text-center shadow-2xl sm:px-12">
          ...
          <div className="relative">
            ...
            <Link
              href="#"
              className="mt-8 inline-flex rounded-xl bg-secondary px-7 py-3.5 text-sm font-bold text-white transition hover:bg-accent"
            >
              Contact Us
            </Link>
          </div>
