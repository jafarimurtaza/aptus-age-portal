        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {contactItems.map((item) => {
            ...
            return (
              <div
                key={item.title}
                className="group border border-base-200 bg-base-100 p-7 text-center shadow-sm transition duration-300 hover:-translate-y-1 hover:border-secondary hover:shadow-xl"
              >
