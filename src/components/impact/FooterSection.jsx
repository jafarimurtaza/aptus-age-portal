...
return (
    <footer className="bg-[#1B3A6B] text-white">
      ...
      <h2 className="text-1xl font-bold text-[#E8EDF5]">
      Afghan <span className="text-[#C8955A]">Geeks</span>
      </h2>
      <div className="text-[#C8955A] text-[10px] uppercase tracking-[0.2em]">
      EDUCATION
      </div>
      </div>
      </div>
      <p className="mt-5 text-white/70 leading-7 max-w-md">
        Empowering Afghan women through technology
        education, innovation, and career opportunities
        in tech.
        </p>

        <div className="flex gap-3 mt-7">
        <a href="https://www.facebook.com/people/Afghan-Geeks/61575217270004/" target="_blank" rel="noopener noreferrer" className="
          w-11 h-11 rounded-xl bg-[#152D52] border border-white/10 flex items-center justify-center hover:bg-[#C8955A] hover:text-[#1B3A6B] hover:-translate-y-1 transition-all">
        <FaFacebook size={20}/>
        </a>
        <a href="/https://www.linkedin.com/company/afghan-geeks-education/" target="_blank" rel="noopener noreferrer" className="
          w-11 h-11 rounded-xl bg-[#152D52] border border-white/10 flex items-center justify-center hover:bg-[#C8955A] hover:text-[#1B3A6B] hover:-translate-y-1 transition-all">
        <FaLinkedin size={20}/>
        </a>
        <a href="/ https://www.youtube.com/@afghangeeks/" target="_blank" rel="noopener noreferrer" className="
          w-11 h-11 rounded-xl bg-[#152D52] border border-white/10 flex items-center justify-center hover:bg-[#C8955A] hover:text-[#1B3A6B] hover:-translate-y-1 transition-all">
        <FaYoutube size={20}/>
        </a>
        </div>
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-6 py-6 flex flex-col md:flex-row justify-between items-center gap-4 text-center">
