    ...
    <section className="w-full bg-base-100 px-4 pb-12 pt-12 text-base-content sm:px-8 sm:py-16 lg:px-16 xl:px-20 xl:py-24">
      <div className="mx-auto grid max-w-7xl items-center gap-10 xl:min-h-[560px] xl:grid-cols-[0.95fr_1.05fr] xl:gap-12">
        <div className="mx-auto max-w-xl text-center xl:mx-0 xl:text-left">
          <h1 className="inline-flex rounded-full border border-primary/30 bg-base-200 px-4 py-2 text-sm font-semibold text-base-300 shadow-sm shadow-primary/10 sm:px-5 sm:py-2.5 sm:text-base">
          ...
          <div className="mt-8 flex flex-row flex-wrap justify-center gap-3 sm:gap-5 xl:mt-12 xl:justify-start">
            <button className="btn min-w-36 border-0 bg-base-300 px-5 text-sm text-base-100 shadow-md shadow-base-300/15 hover:bg-neutral sm:min-w-52 sm:px-8 sm:text-base">
              Browse Graduates
            </button>

            <button className="btn min-w-32 border-primary/40 bg-base-100 px-5 text-sm text-base-300 shadow-sm hover:border-primary hover:bg-base-200 sm:min-w-44 sm:px-8 sm:text-base">
              Try Aptus AI
            </button>
          </div>
        </div>
