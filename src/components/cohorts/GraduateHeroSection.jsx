...
export default function Hero() {
  return (
    ...
    >
      ...
      <div
        className="absolute inset-0 z-1 bg-[#0b0f19]/55"
        aria-hidden="true"
      />

      {/* ── Subtle navy wash for readable text ── */}
      <div
        className="absolute inset-0 z-2 bg-linear-to-r from-[#0b0f19]/70 via-[#0b0f19]/35 to-transparent"
        aria-hidden="true"
      />
      ...
      <div className="relative z-10 mx-auto flex min-h-screen max-w-7xl flex-col justify-center px-5 py-20 sm:px-8 lg:py-24">
        ...
        <div className="home-hero-content max-w-3xl text-left">
          ...
          <div
            className="inline-flex items-center gap-2 border border-gold-light/50 bg-[#0b0f19]/40 px-3 py-2 text-xs font-semibold uppercase tracking-[0.16em] text-cream backdrop-blur-sm"
            role="status"
          >
          ...
          <h1
            id="hero-heading"
            className="mt-7 max-w-3xl text-5xl font-bold leading-[0.98] tracking-[-0.045em] text-cream sm:text-6xl md:text-7xl lg:text-8xl"
          >
            {hero.title.first}
            <br />
          ...
          <p className="mt-7 max-w-xl text-base leading-7 text-cream/80 sm:text-lg sm:leading-8">
            {hero.description}
          </p>

          <div className="mt-8 h-1 w-16 bg-gold" aria-hidden="true" />
        </div>
